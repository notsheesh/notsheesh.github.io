...
export default function ThenAndNow() {
  return (
    <>
      <section id="then" style={sectionStyle}>
        <h2 style={headingStyle}>Then</h2>
      ...
      <section id="now" style={sectionStyle}>
        <h2 style={headingStyle}>Now</h2>

        <p>
          I work on end to end fullchip vmod verif for Rubin and Feynman with a focus on memory systems at{' '}
